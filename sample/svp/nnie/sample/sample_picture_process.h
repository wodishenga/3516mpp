...
extern HI_VOID SAMPLE_Yuv420_to_Mat(Mat &dst, unsigned char* pYUV420, int width, int height, int Flag);

/*火焰检测算法*/
extern HI_S32 SAMPLE_Flame_Detection(Mat src);

/*保存图片*/
extern HI_S32 SAMPLE_SVP_NNIE_Yolov3_SaveBitMap(VIDEO_FRAME_S* pVBuf,int Flag);
