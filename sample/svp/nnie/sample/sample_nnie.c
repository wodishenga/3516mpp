...
static SAMPLE_IVE_SWITCH_S s_stYolovSwitch = {HI_FALSE,HI_FALSE};
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstCnnPara, SAMPLE_SVP_NNIE_CNN_SOFTWARE_PARAM_S* pstCnnSoftWarePara)
{
    ...
    /*malloc mem*/
    s32Ret = SAMPLE_COMM_SVP_MallocMem((HI_CHAR *)"SAMPLE_CNN_INIT",NULL,(HI_U64*)&u64PhyAddr,
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/y/0_28x28.y";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/classification/inst_mnist_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_S32 s32Ret = HI_SUCCESS;
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/segnet_image_224x224.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/segmentation/inst_segnet_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    SAMPLE_SVP_NNIE_INPUT_DATA_INDEX_S stInputDataIdx = {0};
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_FASTERRCNN_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    /*malloc mem*/
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_RCNN_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/single_person_1240x375.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_alexnet_frcnn_cycle.wk";
    HI_U32 u32PicNum = 1;
    ...
    s_stFasterRcnnSoftwareParam.apcRpnDataLayerName[0] = (HI_CHAR *)"rpn_cls_score";
    s_stFasterRcnnSoftwareParam.apcRpnDataLayerName[1] = (HI_CHAR *)"rpn_bbox_pred";
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/double_roipooling_224_224.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_fasterrcnn_double_roipooling_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    HI_U32 i = 0;
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_RFCN_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_RFCN_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
    ...
    HI_U32 u32SrcWidth, HI_U32 u32SrcHeight,HI_U32 u32DstWidth,HI_U32 u32DstHeight)
{
    ...
    SAMPLE_SVP_CHECK_EXPR_RET(u32ClassNum > SAMPLE_SVP_NNIE_MAX_CLASS_NUM+1 ,HI_ERR_SVP_NNIE_ILLEGAL_PARAM,SAMPLE_SVP_ERR_LEVEL_ERROR,
    ...
    if (bRmBg)
    {
        ...
        for (i = 1; i < u32ClassNum; i++)
        {
            ...
            if(((HI_FLOAT)ps32Score[u32ScoreBias] / SAMPLE_SVP_NNIE_QUANT_BASE >=
                paf32ScoreThr)  &&  (ps32ClassRoiNum[i] != 0))
            {
                for (j = 0; j < (HI_U32)ps32ClassRoiNum[i]; j++)
                {
                    /*Score is descend order*/
                    f32Score = (HI_FLOAT)ps32Score[u32ScoreBias + j] / SAMPLE_SVP_NNIE_QUANT_BASE;
                    if ((f32Score < paf32ScoreThr) || (u32RoiNumTmp >= SAMPLE_SVP_NNIE_MAX_ROI_NUM_OF_CLASS))
                    {
                        break;
                    }
    ...
    HI_U32 u32BaseWidth,HI_U32 u32BaseHeight)
{
    ...
    &(pstSwParam->stDstRoi), &(pstSwParam->stClassRoiNum), 0.8f,HI_TRUE,&(pstSwParam->stRect),
...
//	  SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
	...
	HI_U32 u32BaseWidth,HI_U32 u32BaseHeight)
{
   ...
   // s32Ret = SAMPLE_SVP_NNIE_Rfcn_Proc(pstParam,pstSwParam);
	s32Ret = SAMPLE_SVP_NNIE_Yolov3_Proc(pstParam,pstSwParam);
	SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
...
static HI_VOID* SAMPLE_SVP_NNIE_Yolov3_ViToVo(HI_VOID* pArgs)
{
    ...
    while (HI_FALSE == s_bNnieStopSignal)
    {
		...
		//add by zhushengjie
		bCaptureFram = (stExtFrmInfo.stVFrame.u32TimeRef % 10) ? HI_FALSE : HI_TRUE;
		...
		{
			/*把告警标志位加入队列*/
			SAMPLE_SVP_NNIE_Yolov3_AddDetectFlagToList(isAlarm);
			/*事件处理*/
			SAMPLE_SVP_NNIE_Yolov3_ProcessAlarm(isAlarm, &stBaseFrmInfo.stVFrame);
...
{
	HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_rfcn_resnet50_cycle_352x288.wk";
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    SIZE_S stSize;
    ...
    s_stRfcnSoftwareParam.apcRpnDataLayerName[0] = (HI_CHAR *)"rpn_cls_score";
    s_stRfcnSoftwareParam.apcRpnDataLayerName[1] = (HI_CHAR *)"rpn_bbox_pred";
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/hoser_dog_car_person_800x600.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_rfcn_resnet50_cycle.wk";
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    SAMPLE_SVP_NNIE_INPUT_DATA_INDEX_S stInputDataIdx = {0};
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_SSD_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_SSD_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/dog_bike_300.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_ssd_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
	...
	endTime = clock();
   SAMPLE_SVP_TRACE_INFO("cost time %d \n", endTime-beginTime);
    SAMPLE_SVP_NNIE_PERF_STAT_END_LOOP();
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV1_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_YOLOV1_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/dog_bike_car_448x448.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_yolov1_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV2_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    u32ClassRoiNumSize = SAMPLE_SVP_NNIE_ALIGN16(u32ClassNum*sizeof(HI_U32));
    u32TotalSize = u32TotalSize+u32DstRoiSize+u32DstScoreSize+u32ClassRoiNumSize+u32TmpBufTotalSize;
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_YOLOV2_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/street_cars_416x416.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_yolov2_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    u32ClassRoiNumSize = SAMPLE_SVP_NNIE_ALIGN16(u32ClassNum*sizeof(HI_U32));
    u32TotalSize = u32TotalSize+u32DstRoiSize+u32DstScoreSize+u32ClassRoiNumSize+u32TmpBufTotalSize;
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_YOLOV3_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
...
{
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_yolov3_cycle.wk";
    HI_U32 u32PicNum = 1;
    HI_S32 s32Ret = HI_SUCCESS;
    SAMPLE_SVP_NNIE_CFG_S   stNnieCfg = {0};
    ...
    /******************************************
     step 1: start vi vpss vo
     ******************************************/
    s_stYolovSwitch.bVenc = HI_FALSE;
    s_stYolovSwitch.bVo   = HI_TRUE;
    s32Ret = SAMPLE_COMM_IVE_StartViVpssVencVo(&s_stViConfig,&s_stYolovSwitch,&enSize);
    SAMPLE_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret, END_Yolov3_0,
        "Error(%#x),SAMPLE_COMM_IVE_StartViVpssVencVo failed!\n", s32Ret);
...
END_Yolov3_0:
    SAMPLE_COMM_IVE_StopViVpssVencVo(&s_stViConfig,&s_stYolovSwitch);
}
...
{
    HI_CHAR *apcSrcFile[3] = {(HI_CHAR *)"./data/nnie_image/vector/Seq.SEQ_S32",
                              (HI_CHAR *)"./data/nnie_image/vector/Vec1.VEC_S32",
                              (HI_CHAR *)"./data/nnie_image/vector/Vec2.VEC_S32"};
    HI_CHAR *pchModelName = (HI_CHAR *)"./data/nnie_model/recurrent/lstm_3_3.wk";
    HI_U8* pu8VirAddr = NULL;
    HI_U32 u32SegNum = 0;
    HI_U32 u32Step = 0;
    HI_U32 u32Offset = 0;
    ...
    s32Ret = SAMPLE_COMM_SVP_MallocMem((HI_CHAR *)"SVP_NNIE_STEP",NULL,(HI_U64*)&s_stLstmNnieParam.stStepBuf.u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,LSTM_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_FASTERRCNN_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    /*malloc mem*/
    s32Ret = SAMPLE_COMM_SVP_MallocCached((HI_CHAR *)"SAMPLE_Pvanet_INIT",NULL,(HI_U64*)&u64PhyAddr,
        (void**)&pu8VirAddr,u32TotalSize);
    SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,s32Ret,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,Malloc memory failed!\n");
    memset(pu8VirAddr,0, u32TotalSize);
...
{
    HI_CHAR *pcSrcFile = (HI_CHAR *)"./data/nnie_image/rgb_planar/horse_dog_car_person_224x224.bgr";
    HI_CHAR *pcModelName = (HI_CHAR *)"./data/nnie_model/detection/inst_fasterrcnn_pvanet_inst.wk";
    HI_U32 u32PicNum =1;
    HI_FLOAT f32PrintResultThresh = 0.0f;
    HI_S32 s32Ret = HI_SUCCESS;
    HI_U32 i = 0;
   ...
   /*apcRpnDataLayerName is used to set RPN data layer name
    ...
    s_stPvanetSoftwareParam.apcRpnDataLayerName[0] = (HI_CHAR *)"rpn_cls_score";
    s_stPvanetSoftwareParam.apcRpnDataLayerName[1] = (HI_CHAR *)"rpn_bbox_pred";
